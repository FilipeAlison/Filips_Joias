    ...
    <PaperProvider>
      <SafeAreaView style={styles.container}>
        {/* Adicionando a imagem acima do botão */}
                <Image 
                  source={require('../assets/images/clinicalmed.jpg')} 
                  style={styles.image} 
                />
        <Button
                  icon="plus"
                  ...
                  buttonColor="#12122b" // Cor verde para o fundo do botão
      ...
      {agendamentos.length > 0 ? (
        agendamentos.map(agendamento => (
          <DataTable.Row key={agendamento.id}>
            ...
            <DataTable.Cell style={styles.columnCell}><Text>{agendamento.fkServicoId}</Text></DataTable.Cell>
            <DataTable.Cell style={styles.columnCell}><Text>{agendamento.fkUsuarioId}</Text></DataTable.Cell>
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    padding: 16,
    backgroundColor: '#24c0eb', // Cor marrom claro
  },
